...
CREATE TABLE Administrateur(
        idAdministrator     Int  Auto_increment  NOT NULL ,
...
CREATE TABLE absence(
        ...
        idMatiere     Int NOT NULL ,
        idFiliere     Int NOT NULL ,
        dateabsence   Varchar (50) NOT NULL ,
        justification Varchar (200) NOT NULL
        ,CONSTRAINT absence_PK PRIMARY KEY (idStudent,annee,idTeacher,idMatiere,idFiliere)

        ,CONSTRAINT absence_Etudiant_FK FOREIGN KEY (idStudent) REFERENCES Etudiant(idStudent)
        ,CONSTRAINT absence_anneescolaire0_FK FOREIGN KEY (annee) REFERENCES anneescolaire(annee)
        ,CONSTRAINT absence_Enseignant1_FK FOREIGN KEY (idTeacher) REFERENCES Enseignant(idTeacher)
        ,CONSTRAINT absence_Matiere2_FK FOREIGN KEY (idMatiere) REFERENCES Matiere(idMatiere)
        ,CONSTRAINT absence_Filiere3_FK FOREIGN KEY (idFiliere) REFERENCES Filiere(idFiliere)
)ENGINE=InnoDB;
