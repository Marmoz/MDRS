...
?>
<div class='container'>
<div><h1>Bienvenue sur MadrassApp</h1> </div>
...
?>
	...
	<div>
		...
		<label for="login_string" class="form_label">Identifiant</label><br />
		<input type="text" name="login_string" id="login_string" class="form_input" autocomplete="off" maxlength="255" />

		<br />
<br />	
		<label for="login_pass" class="form_label">Mot de passe</label><br />
...
<br /><br />
		...
		<input class="btn btn-info" type="submit" name="submit" value="Se Connecter" id="submit_button"  />
<p>
			<?php
