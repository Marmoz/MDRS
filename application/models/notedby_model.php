    ...
    */
	...
	public function create($unedata) {
     ...
     public function getALL()
        {
    $this->db->select('Etudiant.nomStudent, Etudiant.prenomStudent, Matiere.nomMatiere, Enseignant.nomTeacher, notedby.note_S1, notedby.note_S2, notedby.note_Oral, notedby.annee, notedby.idTeacher, notedby.idStudent, notedby.idMatiere');
$this->db->from('notedby');
