...
class Etudiant_model extends MY_Model {
      ...
      public function give_all()
        ...
        {
          $query = $this->db->query("SELECT Etudiant.idStudent, Etudiant.nomStudent, Etudiant.prenomStudent,Etudiant.emailStudent , inscrit.annee, Filiere.nomFiliere, Filiere.idFiliere, inscrit.numInscription
FROM ((Etudiant
...
ORDER BY annee DESC, nomFiliere");
        ...
        {
          $query = $this->db->query("SELECT * , inscrit.annee, Filiere.nomFiliere, Filiere.idFiliere, inscrit.numInscription
FROM ((Etudiant
RIGHT JOIN inscrit ON Etudiant.idStudent = inscrit.idStudent)
RIGHT JOIN Filiere ON inscrit.idFiliere = Filiere.idFiliere)
ORDER BY annee DESC, nomFiliere");
          return $query->result_array();
                } 
                     ...
                     public function dialDaba()
        {
          $query = $this->db->query("SELECT Etudiant.idStudent, Etudiant.nomStudent, Etudiant.prenomStudent, , Filiere.nomFiliere, Filiere.idFiliere, inscrit.numInscription
FROM Inscrit
LEFT JOIN Etudiant ON Etudiant.idStudent = inscrit.idStudent
LEFT JOIN Filiere ON inscrit.idFiliere = Filiere.idFiliere
");
          return $query->result_array();
                }
                     ...
                     public function dialDaba2($notreannee)
        {
          $query = $this->db->query("SELECT Etudiant.idStudent, Etudiant.nomStudent, Etudiant.prenomStudent,Etudiant.user_id, inscrit.numInscription, inscrit.annee, Filiere.nomFiliere, Etudiant.idStudent, Filiere.idFiliere
FROM Inscrit
LEFT JOIN Etudiant ON Etudiant.idStudent = inscrit.idStudent
LEFT JOIN Filiere ON inscrit.idFiliere = Filiere.idFiliere

WHERE inscrit.annee='$notreannee' 
 ...
 ");
        ...
        {
    $this->db->select('Etudiant.nomStudent, Etudiant.prenomStudent, Matiere.nomMatiere, Enseignant.nomTeacher, notedby.note_S1, notedby.note_S2, notedby.note_Oral');
...
$query = $this->db->get();
 ...
 public function notebyUSERMAIL($mailUser)
        {
    $this->db->select('Etudiant.nomStudent, Etudiant.prenomStudent, Matiere.nomMatiere, Enseignant.nomTeacher, notedby.note_S1, notedby.note_S2, notedby.note_Oral, notedby.annee');
$this->db->from('Etudiant');
$this->db->where(array('Etudiant.emailStudent' => $mailUser));
...
$query = $this->db->get();
  ...
  public function getAbsences($idUser)
        {
          $query = $this->db->query("SELECT * FROM Etudiant WHERE user_id='$idUser' ;");
          return $query->result_array();
        }
...
public function give_allAbsence()
        {
  ...
  public function createAbsence($unedata) {
    return $this->db->insert('Absence', $unedata);
  }
